        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="font-medium mt-1">sales@swiftelite.com</p>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">
            Premium and Elite customers receive priority support with dedicated account managers and extended hours.
          </p>
          <div className="bg-muted p-4 rounded-lg">
            <p className="font-medium">Priority Support Line</p>
            <p className="text-primary font-bold">+1 (800) 987-6543</p>
            <p className="text-sm text-muted-foreground mt-2">Available 24/7 for Elite customers</p>
          </div>
        </CardContent>
      </Card>
    </div>
