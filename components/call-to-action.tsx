      ...
      <div className="container">
        <div className="bg-primary rounded-2xl p-8 md:p-12 text-primary-foreground relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready for Premium Delivery Service?</h2>
            <p className="text-xl text-primary-foreground/90 mb-8">
              Experience the difference with SwiftElite's premium courier services. Fast, secure, and reliable delivery
